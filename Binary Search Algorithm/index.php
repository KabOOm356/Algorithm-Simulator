...
if(!$start)
{
	...
	$insert = (isset($_POST['insert'])) ? 'Checked' : '';
	...
	echo "<input type='checkbox' name='insert' $insert /> Insert searched-for values that aren't already in the array<br/><br/>";
	
	echo "Value to initially search for: <input type='text' name='search' value='$search'><br/><br/>";
